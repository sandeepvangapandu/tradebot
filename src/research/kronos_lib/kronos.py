# Vendored from https://github.com/shiyu-coder/Kronos/tree/master/model/kronos.py
# MIT License — see LICENSE.kronos in this directory.
#
# Original source: https://github.com/shiyu-coder/Kronos
# Intra-package import adjusted: `from model.module import *` -> `from .module import *`
...
# Adjusted import: was `from model.module import *`
from .module import (
    TransformerBlock,
    BSQuantizer,
...
class KronosPredictor:
    ...
    def predict_batch(self, df_list, x_timestamp_list, y_timestamp_list, pred_len, T=1.0, top_k=0, top_p=0.9, sample_count=1, verbose=True):
        ...
        Args:
            ...
            x_timestamp_list (List[pd.DatetimeIndex or Series]): List of timestamps for historical data.
            y_timestamp_list (List[pd.DatetimeIndex or Series]): List of future prediction timestamps.
            pred_len (int): Number of prediction steps.
            T (float): Sampling temperature.
            top_k (int): Top-k filtering threshold.
            top_p (float): Top-p (nucleus sampling) threshold.
            sample_count (int): Number of parallel samples per series.
            verbose (bool): Whether to display autoregressive progress.

        Returns:
            List[pd.DataFrame]: List of prediction results.
        """
