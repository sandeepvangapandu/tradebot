# Vendored from https://github.com/shiyu-coder/Kronos/tree/master/model/module.py
# MIT License — see LICENSE.kronos in this directory.
#
# Original source: https://github.com/shiyu-coder/Kronos
# Commit: see LICENSE.kronos for vendored commit SHA.
#
# Intra-package imports adjusted for vendoring (no changes needed — pure stdlib/torch/einops).
